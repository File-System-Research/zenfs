...
// aquafs::FSSequentialFileWrapper {
//  public:
//   MySequentialFileWrapper(aquafs::FSSequentialFile* target):
//     aquafs::FSSequentialFileWrapper(target) {}
...
//     return aquafs::FSSequentialFileWrapper::Read(n, options,
//     result,
//                                                 scratch, dbg);
//   }
