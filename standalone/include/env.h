...
// aquafs::SequentialFileWrapper {
//  public:
//   MySequentialFileWrapper(aquafs::SequentialFile* target):
//     aquafs::SequentialFileWrapper(target) {}
//   Status Read(size_t n, Slice* result, char* scratch) override {
//     cout << "Doing a read of size " << n << "!" << endl;
//     return aquafs::SequentialFileWrapper::Read(n, result,
//     scratch);
//   }
