...
#ifndef ROCKSDB_ZONE_RAID1_H
#define ROCKSDB_ZONE_RAID1_H
...
class Raid1ZonedBlockDevice : public AbstractRaidZonedBlockDevice {
 public:
  Raid1ZonedBlockDevice(
